...
var count=document.createElement('script');count.type='text/javascript';count.async=true;count.src='//hello.myfonts.net/count/271643';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if(typeof(woffEnabled)=='undefined'){var woffEnabled=true;}
...
suffix="_unhinted";var fonts=[{"fontFamily":"VerbCondRegular-Bold","url":wfpath+"271643_0"+suffix+"_0."+webfontType},{"fontFamily":"VerbCondExtrabold-Italic","url":wfpath+"271643_1"+suffix+"_0."+webfontType},{"fontFamily":"VerbCondExtralight-Italic","url":wfpath+"271643_2"+suffix+"_0."+webfontType},{"fontFamily":"VerbCondLight","url":wfpath+"271643_3"+suffix+"_0."+webfontType},{"fontFamily":"VerbCondRegular-Italic","url":wfpath+"271643_4"+suffix+"_0."+webfontType},{"fontFamily":"VerbCondSemibold","url":wfpath+"271643_5"+suffix+"_0."+webfontType}];var len=fonts.length;if(webfontType=="ttf"){var data_fn=suffix=="_unhinted"?"271643_data_unhintedttf.css":"271643_datattf.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
else if(webfontType=="woff"){var data_fn=suffix=="_unhinted"?"271643_data_unhintedwoff.css":"271643_datawoff.css";document.write("<link rel='stylesheet' type='text/css' href='"+wfpath+data_fn+"'>");}
